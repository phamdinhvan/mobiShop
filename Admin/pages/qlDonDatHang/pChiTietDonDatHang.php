...
<fieldset>
	...
	<div id="tinhtrang">
	<a href="pages/qlDonDatHang/xlDonDatHang.php?a=2&id=<?php echo $id; ?>" class="btnGiaoHang" style="font-size:15px; color:red">
		Giao hàng
	</a>
	<a href="pages/qlDonDatHang/xlDonDatHang.php?a=3&id=<?php echo $id; ?>" class="btnThanhToan" style="font-size:15px; color:red">
		Thanh toán
	</a>
	<a href="pages/qlDonDatHang/xlDonDatHang.php?a=4&id=<?php echo $id; ?>" class="btnHuy" style="font-size:15px; color:red">
		Hủy đơn hàng
	</a>
	<a href="#" onclick="window.print();" class="btnInDonHang" style="font-size:15px; color:red" >
		In đơn hàng
	</a>
	</div>
</fieldset>
...
<table cellspacing="0" border="1">
	...
	?>
			<tr>
				...
				<td><img src="../images/<?php echo $row["HinhURL"]; ?>" height="35" /></td>
