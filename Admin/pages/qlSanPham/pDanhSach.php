...
<center><table cellspacing="0" border="1">
	...
	<?php
		$sql ="SELECT s.MaSanPham, s.TenSanPham, s.HinhURL, s.GiaSanPham, s.NgayNhap, s.SoLuongTon, s.SoLuongBan, s.SoLuocXem, s.MoTa, s.BiXoa, l.TenLoaiSanPham, h.TenHangSanXuat, x.TenXuatXu 
		FROM sanpham s, loaisanpham l, xuatxu x, hangsanxuat h WHERE s.MaLoaiSanPham = l.MaLoaiSanPham AND s.MaXuatXu = x.MaXuatXu AND s.MaHangSanXuat = h.MaHangSanXuat ORDER BY s.MaSanPham DESC";
